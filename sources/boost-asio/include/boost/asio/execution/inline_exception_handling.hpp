...
#ifndef BOOST_ASIO_EXECUTION_INLINE_EXCEPTION_HANDLING_HPP
#define BOOST_ASIO_EXECUTION_INLINE_EXCEPTION_HANDLING_HPP
...
struct inline_exception_handling_t
{
  ...
  {
    return boost::asio::query(ex, propagate_t());
  }
...
#endif // !defined(__clang__)
  {
    return boost::asio::query(ex, capture_t());
  }
...
#endif // !defined(__clang__)
  {
    return boost::asio::query(ex, terminate_t());
  }

  BOOST_ASIO_STATIC_CONSTEXPR_DEFAULT_INIT(propagate_t, propagate);
  BOOST_ASIO_STATIC_CONSTEXPR_DEFAULT_INIT(capture_t, capture);
  BOOST_ASIO_STATIC_CONSTEXPR_DEFAULT_INIT(terminate_t, terminate);
...
BOOST_ASIO_INLINE_VARIABLE constexpr
...
#endif // BOOST_ASIO_EXECUTION_INLINE_EXCEPTION_HANDLING_HPP
