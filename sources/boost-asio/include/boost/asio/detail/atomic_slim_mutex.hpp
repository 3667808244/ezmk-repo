...
#ifndef BOOST_ASIO_DETAIL_ATOMIC_SLIM_MUTEX_HPP
#define BOOST_ASIO_DETAIL_ATOMIC_SLIM_MUTEX_HPP
...
{
public:
  typedef boost::asio::detail::scoped_lock<atomic_slim_mutex> scoped_lock;
...
#endif // BOOST_ASIO_DETAIL_ATOMIC_SLIM_MUTEX_HPP
